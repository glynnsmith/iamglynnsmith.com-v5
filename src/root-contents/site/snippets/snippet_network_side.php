<div class="widget widget--icon-block widget--icon-block--grid">
  <span class="widget__title">Network:</span>
  ...
  <a href="<?php echo $site->tumblr() ?>" class="widget__icon">
    <?php snippet("svg_icon_tumblr") ?>
    <span class="widget__icon-label">Tumblr</span>
  </a>

  <a href="<?php echo $site->soundcloud() ?>" class="widget__icon">
    <?php snippet("svg_icon_soundcloud") ?>
    <span class="widget__icon-label">Soundcloud</span>
  </a>
