<section class="hero-wrapper">
	<section id="hero" class="hero">
		...
		<div data-modifier="8" class="parallax-layer">
			<canvas id="hero__canvas-layer--01" class="hero__canvas-layer--01"></canvas>
		</div>
		<div data-modifier="7" class="parallax-layer">
		...
		<div id="hero__logo-group" data-modifier="5" class="parallax-layer hero__logo-group">
		...
		<div data-modifier="3" class="parallax-layer">
